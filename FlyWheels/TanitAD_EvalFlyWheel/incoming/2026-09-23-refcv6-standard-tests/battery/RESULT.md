...
|---|---|---|---|---|
| step 1000 (kit) | VOID (M1 no power) | **PASS** | pending: probe queued behind the gate | pipeline validation only: seed 0 rolled on GPU; panel on CPU (§3) |
...
* wrapper micro vs plain: 8.4e-4 max relative;
