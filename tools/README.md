...
Tests: `pytest tools/tests/` — **127 falsifiers, 27.2 s** (2026-07-25; was 55 on
07-20). Each drives a throwaway git repo or a synthetic pytest project end-to-end;
the CUDA-specific ones skip loudly on a CPU-only box.
