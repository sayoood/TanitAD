...
1. **T3's verdict** (running) — does a rule-labelled scorer beat the 0.4907 in-sample ceiling? **If T3 refutes, the selector change is not validated and the run should not include it.**
