...
| 2026-07-11 | refa-30k | tanitad-pod2 A40 (existing pod, no new resource) | 0 incremental | — | REF-A frozen-DINO reference arm: adapter + shared predictor on cached `/opt/dino_feats`, 30k steps, rollout_k=4 (D-027); answers H4 + arbitrates D1 capacity-ceiling vs training-time. W30 P2 governance row — runs on the already-approved A40 | **Sayed — explicitly pre-approved 2026-07-11 (W30)**; rides approved A40 (+$0 incremental) |
| 2026-07-11 | refb-post30k | tanitad-pod1 A6000 (existing pod after the 30k record run terminates; or a fresh pod within envelope) | 40 (envelope) | — | REF-B vision-action E2E reference (budget-matched, no world model) — D4 learned opponent — plus post-30k / Stage-1 continuation re-based on K=4 (D-027). Gated on the 30k full-val verdict read | **Sayed — explicitly pre-approved 2026-07-11 (W30)**; condition lifted — up to the $40 envelope + ≤$50/wk guardrail, no further ask needed |

**Phase 0 running total: $0 settled / $120 planned** (base $80 = the two W28–29 pods; +$40 = the
2026-07-11 post-30k/REF-B envelope Sayed explicitly pre-approved in W30. REF-A rides the approved A40
at $0 incremental. Actual spend still **$0 settled**; local 4060 + Colab-free tier unchanged. Guardrail
≤ $50/week honoured — the pre-approval covers the post-30k continuation without a further ask.)
