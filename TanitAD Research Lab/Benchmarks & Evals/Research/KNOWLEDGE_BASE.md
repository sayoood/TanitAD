...
- [2026-09-05] [lib 2511.18729 GuideFlow, CVPR 2026, full text] On navhard the SCORER is worth +15.9 EPDMS (27.1 no-scorer -> 43.0) while all three generative constraint mechanisms together are worth +4.0, and per-step velocity forcing is the WEAKEST of the three (+1.4) because "CVF performs corrections at every step, disrupting smoothness; CF applies once" — impact: REF-C ranking never seeing the refined fan (201/201) disconnects this family largest published lever; prefer ONE late anchor replacement over a per-step penalty in refcv5 — link: `Frontier Scan/Daily/2026-09-05/RESULT.md` F3
- [2026-09-05] [triangulation: 2511.18729 + 2605.31476 + 2510.04333] Three independent 2026 navhard tables cap EPDMS at <=45.0 (best 45.0; two claim SOTA at 36.9-38.0) against the 55.5/56.3 in our own backlog row 32 — impact: BARRED from any comparability table pending a scoring-basis reconciliation (register debt D-10); V-5 split/era corruption path, observed — link: `Frontier Scan/Daily/2026-09-05/RESULT.md` F4

[2026-09-09] [lib 2603.24581 FULL TEXT + NAVSIM maintainers] navhard (23.1-45.0) and "NAVSIM v2" 12k-scenario (84.8-89.3) EPDMS are TWO DISJOINT POPULATIONS wearing one metric name, and the maintainers themselves discourage self-reported splits - impact: debt D-10 resolved in MECHANISM, our own 55.5/56.3 match neither cluster so row 32 stays BARRED, new guideline T-4 (split stamp) and T-5 (inference-time vs training-time params) - TanitAD Research Lab/Benchmarks & Evals/Research/2026-09-09-navsim-split-reconciliation/RESULT.md
- [2026-09-10] [arXiv 2506.04218v2, the NAVSIM v2 maintainers' own paper] **navhard = "450 Stage 1 and 5462 Stage 2 observations"** with anchors PDM-Closed 51.3 / Latent TransFuser 23.1 / MLP 12.7 / ConstVel 10.9; navtest ≈ 12,000 — impact: **the 84.8–89.3 cluster is navtest-EPDMS and may not be called navhard (six numbers stamped); ⛔ but PDM-Closed reads 51.3 AND 56.6 on "navhard", so the scoring basis stays OPEN and row 32 stays BARRED**; our own "navhard ≤ 45.0" cap is superseded — `Benchmarks & Evals/Research/2026-09-10-navhard-split-stamp/RESULT.md`
- [2026-09-10] [arXiv 2609.00111v1 Qwen-Drive-1.0, Table 7 vs Tables 5–6] **One model, four evaluation tiers, and the ranking REVERSES**: best NAVSIM PDMS (90.7) and best test RFS (7.91), but AlpaSim closed-loop score **0.16 vs Alpamayo-R1's 0.36** on 916 scenarios, same setting — impact: **a published single-source rank inversion is now the programme's strongest external evidence for guideline S-1 (T1 is the burden of proof)**, and our claim narrows from "nobody evaluates closed-loop" to "the field's open-loop headlines contradict its own closed-loop tables" — `Opponent Analysis/Research/2026-09-10-qwen-drive-teardown/RESULT.md`
- [2026-09-13] [arXiv 2506.04218 v2 vs v3 + 2606.07170] PDM-Closed navhard 51.3 vs 56.6 are **two versions of the maintainers' paper** (08/2025 vs 03/2026 leaderboard snapshot): Stage 1 identical 9/9, Stage 2 re-scored 7/9 — impact: D-10 CLOSED; every external EPDMS carries a snapshot stamp; our 09-10 reading of v2 while holding v3 caused the contradiction — `Benchmarks & Evals/Research/2026-09-13-pdmc-stage2-provenance/RESULT.md`

- [2026-09-17] [PUBLISHED-ISSUE navsim#151 + arXiv 2607.07196] **NAVSIM #151 is a `human_penalty_filter` inconsistency in the WEIGHTED metrics array — which contains EP** (EP5/TTC5/LK2/HC2/EC2), so `E-BE-FIX151-1`'s second committed branch fires and the stamp table carries a caveat; by construction #151 **cannot** move the multiplicative gates NC/DAC/DDC/TLC, so 09-13's 7/9 movement has a second unnamed cause — plus `2607.07196`'s **L0-L4 admissibility ladder** for WM-as-test-oracle, where **higher visual fidelity (L0) ranked LOWER on action-following (L1-L2)** — impact: an external EPDMS now needs **two** stamps (split + fix), **WA-JEPA's 91.7 is navtest and is excluded from navhard tables**, and backlog row 14 is aiming at **L4 with no L1 check** — `TanitAD Research Lab/Benchmarks & Evals/Research/2026-09-17-navsim-fix151-mechanism/RESULT.md`

- [2026-09-18] [arXiv 2607.07196, full text] **The admissibility ladder's L1 is an action-following test scoped to GENERATIVE sims — trivial for a 3DGS replay — so row 14 is not capped at L0; what binds it is L2 (the spatial envelope, Waymo's W-17-4 concession), and its R²-vs-T1 target can never anchor L4 because T1 is open loop by our own doctrine** — re-scope row 14 to L2-envelope first + T2 anchor (BE18-1) — `Benchmarks & Evals/Research/2026-09-18-ladder-l1-row14/RESULT.md`
- [2026-09-20] [Drive-HWM 2609.03572, local pypdf] Two-stamp catch #2: its EPDMS 86.4 is NAVSIM v2 NAVTEST, not navhard -- the same table carries an Ego-Status blind row at 64.0 and TransFuser at 76.7, and the split is not stamped in the paper (in-PDF 'navhard' = 0 hits). navhard still tops at 57.1 (DriveZero). — impact: 86.4 excluded from the navhard stamp table — [Frontier Scan/Daily/2026-09-20/RESULT.md]
