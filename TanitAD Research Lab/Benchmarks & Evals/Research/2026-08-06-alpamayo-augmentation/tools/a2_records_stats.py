...
REPO = os.environ.get("TANITAD_REPO", r"G:\Meine Ablage\SayBouBase\raw\Projects\TanitAD")
HF_REPO = "Sayood/tanitad-alpamayo2-augmentation"
#: Local copy of the far-side parquet. Override with A2_PARQUET; if it is absent, pull it
#: once with `huggingface_hub.hf_hub_download(HF_REPO, "records.parquet", repo_type="dataset")`
#: — the sha256 check below is what proves the copy IS the published artifact.
