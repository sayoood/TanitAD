...
`paired_openloop.py` · generated `20260926T114743Z` · **0 GPU** (it reads banked dumps only)
...
| `LAT_yaw_rate_mae_radps` | 0.0320 | 0.0304 | 0.0414 | -0.0100* | -0.0114* | **-0.0014** | [-0.0029, -0.0004] | **YES** |
