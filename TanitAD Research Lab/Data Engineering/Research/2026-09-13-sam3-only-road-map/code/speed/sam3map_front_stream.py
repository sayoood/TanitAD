...
os.environ["SAM3MAP_VIEWS"] = "CAM_FW"                                        # refine's module-level camera list: front only
...
def cpu_chain(tag, c8, ego_path):
    env = dict(os.environ, SAM3MAP_ROOT=str(SM / "native7"), SAM3MAP_VIEWS="CAM_FW", SAM3MAP_TAG=tag, PYTHONPATH=PP, HF_HUB_OFFLINE="1", OMP_NUM_THREADS="4")
    t = {}
    steps = [
