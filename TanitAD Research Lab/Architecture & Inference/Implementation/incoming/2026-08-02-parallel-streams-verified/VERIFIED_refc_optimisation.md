...
`TanitAD Research Lab/Production & Optimization/THOR_ACCESS_BRIEF.md:70` lists the four pulling dirs as `refc-base`, `refc-xl`, `refc-base-e1b-clsft`, **`flagship-v4.2b`** — three REF-C, one flagship. The report itself says flagship-v4.2b is not REF-C in §1 and then contradicts that in RANK 1.
