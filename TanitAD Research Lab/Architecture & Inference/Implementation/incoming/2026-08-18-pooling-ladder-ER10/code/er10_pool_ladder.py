...
POOL_ARMS = {"p40": (4, 10), "p10": (2, 5), "p4": (2, 2), "p1": (1, 1)}
RP_DIM = 2048
...
def build_features(rows, arm, seeds, th, tw, d_model, device, oracle,
    ...
    for s in seeds:
        P = make_projection(n_units, d_model,
                            [PROJ_SEED_BASE, s, sorted(POOL_ARMS).index(arm)],
                            device)
