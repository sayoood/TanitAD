...
import tanitad_spectral_sizing as sp  # noqa: E402
...
def test_recovers_known_low_rank_knee():
    ...
    # directions into a spurious tail; optimal_k stays robust — see the separate test).
...
def test_end_to_end_worldmodel_latent_path_is_wellformed():
    ...
    # assert structure only — never a sizing claim (P8).
