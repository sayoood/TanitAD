...
/home/nvidia/venvs/tanitad-train/bin/python taniteval/tools/refcv3_arm.py \
  ...
  --window-stride 5 --with-navpred --with-navflip \
  --lead-block /home/nvidia/refcv4b/b1_eval_lead_block.npz \
  --n-boot 2000 --seed 0 \
  --dump-dir /home/nvidia/navpred/navflip_dump \
  --out /home/nvidia/navpred/refcv4b_navflip.json \
  --tiers os=T1,os_navshuf=T1,os_navzero=T1,os_navflip=T1,os_navpred=T1
echo "ZZEXIT-$?-ZZ"
