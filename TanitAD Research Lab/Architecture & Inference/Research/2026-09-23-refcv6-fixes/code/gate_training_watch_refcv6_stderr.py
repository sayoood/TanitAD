...
mutation_proof_training_watch_refcv6_stderr.json."""
import hashlib
import io
import json
import os
...
TIP = "fe5872fadc36238334533ffbd5b7c7e2a107b34d"
GIT = dict(os.environ, GIT_DIR="C:/Users/Admin/tanitad-push/.git")
TC = pathlib.Path("C:/Users/Admin/tcJ")
...
def main():
    ...
    (W / "mutation_proof_training_watch_refcv6_stderr.json").write_text(json.dumps(res, indent=1),
                                                                         encoding="utf-8")
    print(res["_VERDICT"])
