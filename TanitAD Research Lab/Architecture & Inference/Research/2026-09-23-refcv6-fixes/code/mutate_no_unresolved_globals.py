"""MUTATION PROOF for `test_no_unresolved_globals.py`. Anchors are WHOLE LINES.

  G1  the map loss reads `args` again (the NameError the first real step hit)
  G2  the box3d loss reads `args` again
"""
...
TESTF = REPO / "stack" / "tests" / "test_no_unresolved_globals.py"
TESTS = REPO / "stack" / "tests" / "test_no_unresolved_globals.py"
...
MUTATIONS = [
    ("G1_map_loss_reads_args_again", TRAIN,
    ...
    ("G2_box3d_loss_reads_args_again", TRAIN,
...
def main() -> int:
    ...
    res = {"_what": "mutation proof that test_no_unresolved_globals.py can FAIL",
    ...
    try:
        ...
        for name, target, old, new in MUTATIONS:
            ...
            if len(hits) != 1:
                ...
                pathlib.Path("C:/Users/Admin/qland/work/pbox/mutation_proof_no_unresolved_globals.json"
    ...
    res["_VERDICT"] = (
        ...
        "both historical NameError sites; both files restored "
    ...
    pathlib.Path("C:/Users/Admin/qland/work/pbox/mutation_proof_no_unresolved_globals.json").write_text(
