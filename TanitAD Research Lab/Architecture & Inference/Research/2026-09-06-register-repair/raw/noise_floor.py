...
|delta withheld_speed_mae| mean 0.194, max 0.701 m/s; |delta loss| mean 0.495, max 1.728. The
...
def main():
    ...
    # I21 GUARD: the LAST thing written is a completion marker. A reader asserts it
    # before quoting any number; its absence means the generator died mid-write and
    # the file is TRUNCATED, not empty. (2026-09-06 register-repair: the original run
    # crashed on a cp1252 UnicodeEncodeError after the first heading and the artifact
    # still looked like a document.)
    print()
    print("<!-- ARTIFACT-COMPLETE: NOISE_FLOOR v2 -->")
    return 0
