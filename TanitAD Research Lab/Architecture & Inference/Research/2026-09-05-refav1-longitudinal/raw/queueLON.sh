...
run lonvocab_s1 --plan-seed 1 --a-sustain-mode a0
run loncomb     --plan-seed 0 --a-sustain-mode a0 --jerk-seam a0 --target-speed-mode a0ext
run lonvend     --plan-seed 0 --target-speed-mode a0ext
echo "ZZQUEUELON-DONE-$(date -u +%FT%TZ)ZZ"
