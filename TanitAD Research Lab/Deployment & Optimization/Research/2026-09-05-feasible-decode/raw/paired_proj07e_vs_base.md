# PAIRED OPEN-LOOP COMPARISON — base vs proj07e

`paired_openloop.py` · generated `20260905T173425Z` · **0 GPU** (it reads banked dumps only)

## LINE ONE: beats the trivial floor `ha0` on ADE (paired, separated): **base, proj07e**
...
|---|---|---|---|---|
| `base:os` | 0.0000 | 0.0000 | **0.0000** | `proj07e:os` 4402/4823 |
| `proj07e:os` | 0.0000 | 0.0000 | **0.0000** | `base:os` 4402/4823 |
...
* selection profile `proj07e`: **50 distinct anchors**, modal #57 at 0.1482, entropy 2.8425, agrees with the GT-nearest oracle on 0.5652
...
| metric | `base:os` | `proj07e:os` | `shared:ha0` | A−floor | B−floor | (B−f)−(A−f) | 95% CI | separated |
|---|---|---|---|---|---|---|---|---|
| `ade_m` | 0.4419 | 0.4431 | 0.6723 | -0.2304* | -0.2292* | **0.0012** | [0.0002, 0.0024] | **YES** |
| `fde_m` | 0.9288 | 0.9301 | 1.4029 | -0.4741* | -0.4727* | **0.0014** | [-0.0017, 0.0046] | no |

### LONGITUDINAL — family verdict: **proj07e:os**

| metric | `base:os` | `proj07e:os` | `shared:ha0` | A−floor | B−floor | (B−f)−(A−f) | 95% CI | separated |
|---|---|---|---|---|---|---|---|---|
| `LON_speed_mae_mps` | 0.4516 | 0.4495 | 0.4880 | -0.0364* | -0.0385* | **-0.0021** | [-0.0037, -0.0008] | **YES** |
| `LON_along_mae_m` | 0.4030 | 0.4038 | 0.4705 | -0.0674* | -0.0667* | **0.0008** | [-0.0003, 0.0019] | no |
| `LON_accel_mae_mps2` | 0.6806 | 0.6746 | 0.4786 | 0.2020* | 0.1960* | **-0.0060** | [-0.0107, -0.0024] | **YES** |

### LATERAL — family verdict: **SPLIT**

| metric | `base:os` | `proj07e:os` | `shared:ha0` | A−floor | B−floor | (B−f)−(A−f) | 95% CI | separated |
|---|---|---|---|---|---|---|---|---|
| `LAT_cross_mae_m` | 0.1084 | 0.1093 | 0.3132 | -0.2048* | -0.2039* | **0.0009** | [0.0004, 0.0015] | **YES** |
| `LAT_heading_mae_deg` | 1.3591 | 1.3630 | 2.8715 | -1.3741* | -1.3820* | **-0.0079** | [-0.0209, 0.0088] | no |
| `LAT_yaw_rate_mae_radps` | 0.2176 | 0.0427 | 0.0476 | 0.1700* | -0.0049 | **-0.1749** | [-0.2563, -0.1088] | **YES** |

### TACTICAL — family verdict: **no separation**

| metric | `base:os` | `proj07e:os` | `shared:ha0` | A−floor | B−floor | (B−f)−(A−f) | 95% CI | separated |
|---|---|---|---|---|---|---|---|---|
| `TAC_traj_lat_correct` | 0.9540 | 0.9544 | 0.8659 | 0.0881* | 0.0885* | **0.0004** | [-0.0017, 0.0023] | no |
| `TAC_traj_lon_correct` | 0.7477 | 0.7479 | 0.7576 | -0.0100 | -0.0097 | **0.0002** | [0.0000, 0.0006] | no |
...
| `TAC_declared_lat:true_minus_navshuffled` | `proj07e:os` | 0.0242 | [-0.0017, 0.0544] | no |
...
| `TAC_declared_lat:true_minus_navzero` | `proj07e:os` | 0.0294 | [-0.0095, 0.0700] | no |
...
| `TAC_declared_lon:true_minus_navshuffled` | `proj07e:os` | 0.0147 | [-0.0052, 0.0354] | no |
...
| `TAC_declared_lon:true_minus_navzero` | `proj07e:os` | 0.0182 | [-0.0112, 0.0464] | no |
...
| `STR_route:true_minus_navshuffled` | `proj07e:os` | 0.0000 | [0.0000, 0.0000] | no |
...
| `STR_route:true_minus_navzero` | `proj07e:os` | 0.0000 | [0.0000, 0.0000] | no |
...
`proj07e` publishes: `train_labels_md5` = `0ff902130ce76886b8a925eceed9e3a5`, `train_labels_n_records` = `4572`, `train_labels_path` = `/workspace/TanitAD/data/s2_labels_v7.2_train.jsonl.gz`. Missing: the run's own config.json was not supplied (--a-run-config / --b-run-config).
...
```
python taniteval/tools/paired_openloop.py --a-dump <refav1 FINAL dump> --a-name base --a-arm os --b-dump <refcv3 FINAL dump> --b-name proj07e --b-arm os  --a-run-config <refav1 run config.json> --b-run-config <refcv3 run config.json> --floor ha0 --n-boot 2000 --seed 0 --out taniteval/results/paired-openloop-base-vs-proj07e-<UTC>.json --md <RESULT.md>
```
