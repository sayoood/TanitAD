"""E-DEP-VGEO-4 -- position-matched null + oracle power control. See ../SPEC.md (pinned).
...
OUT = sys.argv[1] if len(sys.argv) > 1 else "raw/vgeo4_step4.json"
...
for name, F in feats.items():
    ...
    if name == "latent_7040":
        ...
        arms["C_presid|latent_7040_diag"] = {"P1r": p1r(diag, "presid")[0]}
        arms["C_mut|latent_7040_diag"] = {"P1r": p1r(diag, "mut")[0]}
        arms["C_oracle"] = {"P1r": p1r(diag, "oracle")[0]}
    print(name, "done", round(time.time() - t0, 1), flush=True)

res = {"spec": "SPEC.md E-DEP-VGEO-4 (position-matched null + oracle power control)",
