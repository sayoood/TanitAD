"""MetaDrive front-camera RGB + perturbation tests (integrated from the
Tools&DevEnv intake package 2026-07-13 per D-011).

Runs with zero simulator dependencies (MetaDrive is lazily imported only inside
the live rollout, which is skipped here).
"""
...
import tanitad.data.metadrive_frontcam as fc
