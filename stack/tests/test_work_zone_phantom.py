...
1. **Telemetry contract** â€” the emitted log has exactly the ScenarioTelemetry field names,
   correct lengths/shapes, and a scenario-specific ``closure_incursion_m`` compliance signal.
2. **Discriminative structure** â€” the scenario actually separates a pixel-reactive baseline
...
from tanitad.eval.scenarios.work_zone_phantom import (
    POLICIES,
    TELEMETRY_KEYS,
