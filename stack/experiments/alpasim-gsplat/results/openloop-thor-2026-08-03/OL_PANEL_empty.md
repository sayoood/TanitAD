# OPEN-LOOP panel — flagship v1 vs REF-C base, scene 00040136, empty
...
|---|---|---|---|---|
| `ade_0_2s` | 7.1479 [6.0645, 8.3711] | 0.6444 [0.4392, 0.8497] | +6.5035 [+5.4961, +7.7434] | **separated** |
| `de_0_5s` | 2.9434 [2.5306, 3.3662] | 0.0739 [0.0491, 0.0995] | - |  |
| `de_1s` | 5.7743 [4.9488, 6.6760] | 0.3310 [0.2159, 0.4504] | - |  |
| `de_1_5s` | 8.6018 [7.2978, 10.0661] | 0.7797 [0.5221, 1.0425] | - |  |
| `de_2s` | 11.2721 [9.4975, 13.4087] | 1.3930 [0.9684, 1.8284] | - |  |
...
| metric | flagship-v1 | refc-base | paired Δ (A−B) | |
|---|---|---|---|---|
| `target_speed_err_ms` | -5.9517 [-6.7660, -5.1379] | 0.0118 [-0.0086, 0.0291] | - |  |
| `abs_target_speed_err_ms` | 5.9517 [5.1379, 6.7660] | 0.0526 [0.0430, 0.0613] | +5.8991 [+5.0862, +6.7143] | **separated** |
| ~~`executed_speed_err_ms`~~ | 0.0000 [0.0000, 0.0000] | 0.0000 [0.0000, 0.0000] | +0.0000 [+0.0000, +0.0000] | ⛔ setup, not result |
| `along_track_ade_m` | 7.1374 [6.0540, 8.3617] | 0.6022 [0.3899, 0.8092] | +6.5353 [+5.5348, +7.7702] | **separated** |
| `along_track_0_5s_m` | 2.9431 [2.5303, 3.3659] | 0.0710 [0.0450, 0.0974] | - |  |
| `along_track_1s_m` | 5.7712 [4.9461, 6.6737] | 0.3082 [0.1862, 0.4303] | - |  |
| `along_track_1_5s_m` | 8.5910 [7.2860, 10.0577] | 0.7244 [0.4516, 0.9916] | - |  |
| `along_track_2s_m` | 11.2445 [9.4669, 13.3860] | 1.3051 [0.8773, 1.7268] | - |  |
...
| metric | flagship-v1 | refc-base | paired Δ (A−B) | |
|---|---|---|---|---|
| `heading_err_rad` | 0.0469 [0.0366, 0.0554] | 0.0277 [0.0179, 0.0413] | +0.0192 [+0.0033, +0.0328] | **separated** |
| `curvature_err_1pm` | 0.0028 [0.0018, 0.0037] | 0.0011 [0.0006, 0.0017] | +0.0017 [+0.0008, +0.0026] | **separated** |
| `yawrate_err_rads` | 0.0425 [0.0312, 0.0547] | 0.0085 [0.0057, 0.0122] | +0.0340 [+0.0225, +0.0466] | **separated** |
...
| `lateral_ade_m` | 0.3077 [0.2478, 0.3732] | 0.1644 [0.1138, 0.2246] | +0.1433 [+0.0688, +0.2196] | **separated** |
...
| metric | flagship-v1 | refc-base | paired Δ (A−B) | |
|---|---|---|---|---|
| `manoeuvre_plan_eq_logged` | 0.4412 [0.1302, 0.7707] | 0.4059 [0.1657, 0.6413] | +0.0353 [-0.4765, +0.5296] | not separated |
| `manoeuvre_exec_eq_plan` ⚠️ | 0.4000 [0.1000, 0.7778] | 0.4000 [0.1111, 0.7273] | - | alias of plan_eq_logged |
| `head_eq_plan` | 0.1529 [0.0419, 0.2789] | 0.5118 [0.2189, 0.7854] | - |  |
| `head_eq_logged` | 0.0765 [0.0134, 0.1728] | 0.1706 [0.0053, 0.3822] | - |  |

* **A `plan_class_share`** — `{"lane_keep": 0.0, "turn_left": 0.0, "turn_right": 0.0235, "accelerate": 0.0, "brake_stop": 0.9765}`
...
* **A `head_class_share`** — `{"lane_keep": 0.0706, "turn_left": 0.0647, "turn_right": 0.4706, "accelerate": 0.2647, "brake_stop": 0.1294}`
...
| `route_head_eq_logged` | 1.0000 [1.0000, 1.0000] ⛔degenerate ⚠️echo-unidentifiable | 0.2373 [0.0000, 0.6364] ⛔degenerate ⚠️echo-unidentifiable | +0.7627 [+0.3636, +1.0000] | **separated** |
| `route_head_side_eq_graded_proxy` | 0.1412 [0.0000, 0.3905] ⚠️echo-unidentifiable | 0.4176 [0.1562, 0.6883] ⚠️echo-unidentifiable | - |  |
